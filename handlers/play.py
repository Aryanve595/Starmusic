# @alone_shaurya_king // @Heartlessaryan_op
...
async def play(_, message: Message):
    ...
    try:
        ...
        user.first_name = "Star_music_robot"
    usar = user
    wew = usar.id
    try:
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/7ec38d747e3c9b6854d06.jpg"
            ...
            [
                [
                        InlineKeyboardButton(
                            text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭",
                            url=f"https://t.me/+D-BHHAF3u1piMjQ1")
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/7ec38d747e3c9b6854d06.jpg", 
                             caption="**⚡𝗦𝘁𝗮𝗿 𝗠𝘂𝘀𝗶𝗰⚡ ᴍᴜꜱɪᴄ\n ɴᴏᴡ ▶️ ᴘᴀᴜꜱᴇᴅ ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALL:
        await message.reply_text("**⚡𝗦𝘁𝗮𝗿 𝗠𝘂𝘀𝗶𝗰⚡ ᴍᴜꜱɪᴄ \n ɴᴏᴛʜɪɴɢ ᴘʟᴀʏɪɴɢ ...**")
    else:
